...
resultPath = '/home/rana/Thesis/DrQA/upal/_Results/CNN/Gyro/'

LOOP_COUNT = 3
SAVE_MODEL_NAME = 'CNNGyroNpy_CONV_20_5_CONV6_10_5_MP_D200'
...
# model 1
model = Sequential()
model.add(Conv1D(filters=20, kernel_size=5,activation='relu',input_shape=(SEQ_LEN,n_features)))
