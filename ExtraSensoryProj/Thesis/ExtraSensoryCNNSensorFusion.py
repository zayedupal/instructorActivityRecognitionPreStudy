...
ACC_MODEL_NAME = 'CNNAccNpy_CONV_20_5_CONV6_10_5_MP_D200'
...
ExtraSensoryHelperFunctions.save_dict_file(resultPath+'CNN_Acc_Gyro_Fusion_ROC_results.txt',metrics_texts)
...
# plt.show()
plt.savefig(resultPath+'CNN_Acc_Gyro_Fusion_ROC.png')