...
rawDataFolder = 'D:/Upal/Dataset/ExtraSensory.raw_measurements.watch_acc/watch_acc_normalized/'
...
#model 2
# model = Sequential()
# model.add(LSTM(100,input_shape=(SEQ_LEN,n_features),return_sequences=True))
